...
const Result_URL = ({ inputValue }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.post('https://api-ssl.bitly.com/v4/shorten', {
        ...
        headers: {
          'Authorization': ' 443f3489432c36d9155b6cd6f1727050242a2966', // Replace with your Bitly access token
        },
      });
  ...
  return (
    <div>
      ...
      >
        <button
          className={`relative px-10 py-3 font-medium text-white transition duration-300 ${
